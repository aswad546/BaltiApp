...
class _OrderListState extends State<OrderList> {
  ...
  Widget build(BuildContext context) {
    ...
    Widget orderTypeCard(mediaQuery, title, quantity, price, unreadNotifier) {
      return Card(
              ...
              Container(
                ...
                child: Expanded(
                  child: Column(
                    children: [
                      orderTypeCard(
                          mediaQuery, 'Orders in Progress', 10, '1234', true),
                      orderTypeCard(
                          mediaQuery, 'Orders Completed', 15, '1234', false),
                      orderTypeCard(mediaQuery, 'Approval', 2, '1234', true),
                      orderTypeCard(
                          mediaQuery, 'Scheduled Orders', 4, '1234', true),
                    ],
                  ),
                ),
              )
