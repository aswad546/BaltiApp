...
class _BusinessListState extends State<BusinessList> {
  ...
  void initState() {
    ...
    Provider.of<BusinessesList>(context, listen: false)
        .getBusinesses(phoneNumber);
  }
      ...
      body: Padding(
          ...
          child: Column(
              ...
              children: [
                ...
                Expanded(
                    child: context.watch<BusinessesList>().business.isEmpty
                        ? Center(
                            child: Text(
